...
- [004 — Part 97 and encryption: a practical reading for amateur deployments](004-part-97-and-encryption.md) (first published 2026-04-19)

## Planned notes

Not commitments, just directions worth documenting:

- 005 — Identity compromise and revocation in decentralized systems
- 006 — Metadata leakage in federated messaging
- 007 — Channel secret distribution at scale
